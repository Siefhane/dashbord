				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='mowaslaty.home') }}"><img src="{{URL::asset('assets/img/brand/mowaslaty-logo.jpeg')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='mowaslaty.home') }}"><img src="{{URL::asset('assets/img/brand/mowaslaty-logo.jpeg')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='mowaslaty.home') }}"><img src="{{URL::asset('assets/img/brand/mowaslaty-logo.jpeg')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='mowaslaty.home') }}"><img src="{{URL::asset('assets/img/brand/mowaslaty-logo.jpeg')}}" class="dark-logo-2" alt="logo"></a>
						</div>
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">Ramy Mohamed</h5>
												</div>
									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6>Ramy Mohamed</h6><span>Admin Member</span>
											</div>
										</div>
									</div>
